...
export default function ProductAddModal({ open, onClose, onCreated }: ProductAddModalProps) {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    onCreated()
    setForm({
      name: '', description: '', price: '', salePrice: '', stockQuantity: '', category: '', sizes: [], colors: [], imageUrl: '', images: [], specifications: [], brand: '', material: '', careInstructions: '', isFeatured: false, isNewArrival: false, isBestSeller: false, isOnSale: false
    })
    setImageFiles([])
  }
