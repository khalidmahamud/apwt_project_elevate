...
export class CategoryAndProductRelation1751043062526
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ADD "images" text array NOT NULL DEFAULT '{}'`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "images"`);
    await queryRunner.query(
      `ALTER TABLE "products" ADD "images" character varying array NOT NULL DEFAULT '{}'`,
    );
    await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "categoryId"`);
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('CUSTOMER', 'ADMIN', 'DELIVERY_MAN')`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "role" "public"."users_role_enum" NOT NULL DEFAULT 'CUSTOMER'`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."products_category_enum" AS ENUM('ELECTRONICS', 'CLOTHING', 'T_SHIRTS', 'SHIRTS', 'PANTS', 'SHOES', 'ACCESSORIES', 'BOOKS', 'HOME', 'SPORTS', 'BEAUTY', 'FOOD', 'OTHER')`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" ADD "category" "public"."products_category_enum"`,
    );
