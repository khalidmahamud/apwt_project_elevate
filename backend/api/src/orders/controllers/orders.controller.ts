...
export class OrdersController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new order with the specified items and payment details.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a paginated list of orders for the current user with optional filtering.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Updates the status or notes of an existing order. Users can only update their own orders.',
  })
